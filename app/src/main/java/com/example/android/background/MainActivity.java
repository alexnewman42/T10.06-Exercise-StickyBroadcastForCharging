...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            // Call isCharging on the battery manager and pass the result on to your show charging method
            showCharging(batteryManager.isCharging());
        } else {
          /*If your user is not on M+, then... Create a new intent filter with the action ACTION_BATTERY_CHANGED. This is a
